...
from .utils import draw_text_box
...
def draw_bbox(
    ...
    if box_thickness is None:
        box_thickness = get_recommended_box_thickness(
    ...
    if title is not None or title != "":
        ...
        overlay = draw_text_box(image=overlay, text=title, x=x1, y=y1,
                                font=2, font_size=font_size, background_color=color, thickness=1)
